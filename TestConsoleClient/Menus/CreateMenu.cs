    ...
    public static void Run()
    {
      using (var client = new CqrsServiceClient())
      {
        ...
        if (architectureList.All(x => x != name))
        {
          ...
          client.AssignSplAsset(id, system312ExecId, ArchitectureResource.System3_1_2Exec + ArchitectureResource.Asset_Suffix);
          client.AssignSplAsset(id, system313ExecId, ArchitectureResource.System3_1_3Exec + ArchitectureResource.Asset_Suffix);
          client.AssignSplAsset(id, system12DispId, ArchitectureResource.System1_2Disp + ArchitectureResource.Asset_Suffix);
          client.AssignSplAsset(id, system13DispId, ArchitectureResource.System1_3Disp + ArchitectureResource.Asset_Suffix);
          client.AssignSplAsset(id, system21DispId, ArchitectureResource.System2_1Disp + ArchitectureResource.Asset_Suffix);
          client.AssignSplAsset(id, system22DispId, ArchitectureResource.System2_2Disp + ArchitectureResource.Asset_Suffix);
          client.AssignSplAsset(id, system23DispId, ArchitectureResource.System2_3Disp + ArchitectureResource.Asset_Suffix);
          client.AssignSplAsset(id, system311Disp1Id, ArchitectureResource.System3_1_1Disp1 + ArchitectureResource.Asset_Suffix);
          client.AssignSplAsset(id, system311Disp2Id, ArchitectureResource.System3_1_1Disp2 + ArchitectureResource.Asset_Suffix);
          client.AssignSplAsset(id, system311Disp3Id, ArchitectureResource.System3_1_1Disp3 + ArchitectureResource.Asset_Suffix);
          client.CommitVersion(id);
